...
mod tests {
    ...
    fn test_topic_filter_multi_level() {
        let bytes = [
            ...
            0x67, 0x72, 0x6F, 0x6F, 0x6D, 0x2F, 0x6C, 0x69, 0x67, 0x68, 0x74, 0x01,
        ];
        let packet = roundtrip_test(&bytes);
    ...
    fn test_topic_filter_with_wildcards() {
        ...
        let bytes = [
            0x00, 0x01, 0x00, 0x09, 0x73, 0x65, 0x6E, 0x73, 0x6F, 0x72, 0x73, 0x2F, 0x23, 0x01,
        ];
        let packet = roundtrip_test(&bytes);
    ...
    fn test_topic_filter_unicode() {
        ...
        let bytes = [
            0x00, 0x01, 0x00, 0x06, 0xC3, 0xB1, 0xC3, 0xA1, 0xC3, 0xA9, 0x00,
        ];
        let packet = roundtrip_test(&bytes);
    ...
    fn test_topic_filter_special_mqtt_chars() {
        let bytes = [
            0x00, 0x01, 0x00, 0x06, 0x61, 0x2F, 0x62, 0x2B, 0x2F, 0x63, 0x02,
        ];
        let packet = roundtrip_test(&bytes);
    ...
    fn test_roundtrip_unicode_packet() {
        ...
        let bytes = [
            0x00, 0x64, 0x00, 0x06, 0xC3, 0xB1, 0xC3, 0xA1, 0xC3, 0xA9, 0x00,
        ];
        let packet = roundtrip_test(&bytes);
    ...
    fn test_roundtrip_wildcard_packet_qos2() {
        ...
        let bytes = [
            0x01, 0xF4, 0x00, 0x09, 0x73, 0x65, 0x6E, 0x73, 0x6F, 0x72, 0x73, 0x2F, 0x23, 0x02,
        ];
        let packet = roundtrip_test(&bytes);
    ...
    fn test_roundtrip_complex_topic_qos1() {
        ...
        let bytes = [
            0x03, 0xE8, 0x00, 0x0E, 0x73, 0x65, 0x6E, 0x73, 0x6F, 0x72, 0x73, 0x2F, 0x2B, 0x2F,
